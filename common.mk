...
$(call inherit-product-if-exists, vendor/samsung/cprimeltemtr-common/cprimeltemtr-common-vendor.mk)

# Common overlay
DEVICE_PACKAGE_OVERLAYS += device/samsung/cprimeltemtr-common/overlay
